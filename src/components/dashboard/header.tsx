      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 p-2 hover:bg-muted rounded-[6px] transition-colors active:bg-[hsl(var(--muted))]"
          ...
          {showUserMenu && (
            <>
              ...
              />
              <div className="absolute right-0 mt-2 w-48 bg-card rounded-[12px] shadow-lg border border-border py-1 z-20">
                <button
