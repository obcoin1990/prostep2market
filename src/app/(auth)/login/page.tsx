    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Sign in to ProStep</h1>
          <p className="text-sm text-gray-500 mt-1">Corporate learning, supercharged by AI</p>
        </div>

        {/* Google */}
        <button
          onClick={() => signIn('google', { callbackUrl: '/dashboard/learner' })}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-brand-600 disabled:opacity-60"
          >
