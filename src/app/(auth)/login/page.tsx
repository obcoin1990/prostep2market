    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#f5f5f5' }}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm" style={{ color: '#9ea3ad' }}>
            {t('auth.signInContinue')}
          </p>
        </div>

        <div className="rounded-[8px] p-6 bg-white border border-[#eaecef] shadow-lg">
          <SignInForm />
          <DemoLoginButton />
        </div>

        <p className="text-center mt-5 text-sm" style={{ color: '#9ea3ad' }}>
          {t('auth.noAccount')}{' '}
